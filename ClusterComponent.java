...
public class ClusterComponent implements Paintable {
	...
	public HCCluster getCluster() {
		return cluster;
	}

	public void setCluster(HCCluster cluster) {
	...
	public ClusterComponent (HCCluster cluster, boolean printName, VCoord initPoint) {
		this.printName = printName;
		this.cluster = cluster;
		this.initPoint = initPoint;
