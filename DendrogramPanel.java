...
public class DendrogramPanel extends JPanel {
    ...
    public HCCluster getModel() {
        return model;
    }

    public void setModel(HCCluster model) {
        this.model = model;
    ...
    private ClusterComponent createComponent(HCCluster cluster, VCoord initCoord, double clusterHeight) {
        ...
        if (cluster != null) {
            ...
            for (HCCluster child : cluster.getChildren()) {
    ...
    private ClusterComponent createComponent(HCCluster model) {
